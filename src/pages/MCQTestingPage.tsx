      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="card p-6 mb-6">
          ...
          <button
            ...
            className="w-full mt-6 py-4 bg-brand-600 hover:bg-brand-700 disabled:bg-gray-400 text-white rounded-lg font-semibold text-lg transition-colors flex items-center justify-center gap-2"
          >
            <Brain size={24} />
            Start Quiz
          </button>
    ...
    return (
      <div className="max-w-4xl mx-auto">
        <div className="card p-8 text-center">
          ...
          <div className="bg-brand-50 dark:bg-brand-800/40 rounded-lg p-6 mb-6">
          ...
          <div className="flex gap-4 justify-center">
            <button
              onClick={startQuiz}
              className="px-6 py-3 bg-brand-600 hover:bg-brand-700 text-white rounded-lg font-semibold transition-colors flex items-center gap-2"
            >
              <RotateCw size={20} />
              Try Again
            </button>
          ...
          {currentQuestion.options.map((option, index) => {
            ...
            if (showFeedback) {
              ...
              if (index === selectedAnswer) {
                buttonClass += ' border-purple-500 bg-brand-50 dark:bg-brand-800/40';
              } else {
                buttonClass += ' border-gray-300 dark:border-gray-600 hover:border-brand-400';
              }
            }
